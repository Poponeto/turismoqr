...
create table link (idLink varchar(255) not null, permisosUsuario varchar(255), primary key (idLink));
...
create table permisoUsuario (idPermisoUsuario varchar(255) not null, primary key (idPermisoUsuario));
...
alter table link add index idPermisoUsuario (permisosUsuario), add constraint idPermisoUsuario foreign key (permisosUsuario) references usuario (idUsuario);
