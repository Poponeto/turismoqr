...
public class ValidadorDatosPersona implements Validador {
    ...
    public void validar(Object objeto, Errores errores) {
        ...
        } else if (dtoPersona.getFechaDeNacimiento().after(new Date(fechaActual.getYear() - 1900 - 18 + 1900, 0, 1))) {
            errores.agregarError("fechaDeNacimiento", "Debes ser mayor de 18 años.");
        } else if (dtoPersona.getFechaDeNacimiento().before(new Date(fechaActual.getYear() - 1900 - 110 + 1900, 0, 1))) {
